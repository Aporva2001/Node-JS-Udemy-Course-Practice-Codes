...
app.put('/post-image', (req, res, next)=>{
    ...
    if(!req.file){
        return res.status(200).json({message: 'No file provided'}) // we have set the status code to 200 as we also have to handle the edit case in which we may or may not edit the image,
        // So the code above will work for both cases.
    }
        if(req.body.oldPath){
