...
User.hasOne(Cart)
Cart.belongsTo(User) // This statement is the inverse of hasOne relation and is optional.
Cart.belongsToMany(Product , {through: CartItem}) // The through statement tells us where the connections between the Product and Cart table should be stored.
